...
public class WeatherResponse implements Parcelable {
    ...
    private com.eoxys.weatherapp.model.error error;
    ...
    protected WeatherResponse(Parcel in) {
        ...
        this.error = in.readParcelable(com.eoxys.weatherapp.model.error.class.getClassLoader());
    }

    public com.eoxys.weatherapp.model.error getError() {
        return error;
    }

    public void setError(com.eoxys.weatherapp.model.error error) {
        this.error = error;
    }
