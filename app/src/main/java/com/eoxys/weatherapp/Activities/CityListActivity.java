...
public class CityListActivity extends AppCompatActivity implements WeatherTask.MyAsyncTaskListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (preferencesManager.isFirstTime()) {
            ...
            preferencesManager.addItem(getString(R.string.Bangalore));
            preferencesManager.addItem(getString(R.string.Madurai));
            preferencesManager.addItem(getString(R.string.Chennai));
